        ...
        >
          {loading
            ? [1, 2, 3, 4].map((idx) => (
                <div
                  key={idx}
                  className="relative min-h-[420px] md:h-[420px] w-[290px] sm:w-[350px] md:w-[380px] shrink-0 snap-start rounded-[32px] overflow-hidden bg-slate-100 border border-slate-200 p-6 flex flex-col justify-end gap-5 animate-pulse"
                >
                  <div className="w-12 h-12 rounded-full bg-slate-200" />
                  <div className="w-3/4 h-7 bg-slate-200 rounded-lg" />
                  <div className="w-full h-16 bg-slate-200/80 rounded-xl" />
