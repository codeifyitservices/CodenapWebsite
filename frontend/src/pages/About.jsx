  ...
  return (
    <section className="relative pt-36 pb-20 px-6 flex flex-col justify-center items-center overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10 flex flex-col items-center gap-6">
        ...
        >
          At CodeNap, we believe a website should unlock your business's online
          potential. We focus on bridging the gap between strategic brand goals
  ...
  const stats = [
    {
      ...
      glowColor:
        "group-hover:shadow-orange-500/10 group-hover:border-orange-500/40",
      hasDecimal: false,
    },
    {
      id: 2,
      ...
      glowColor:
        "group-hover:shadow-blue-500/10 group-hover:border-blue-500/40",
      hasDecimal: false,
    },
    {
      id: 3,
      ...
      <div className="max-w-6xl mx-auto flex flex-col gap-16">
        ...
        <div className="text-center flex flex-col items-center gap-4">
          ...
          <p className="text-slate-500 text-sm sm:text-base leading-relaxed max-w-2xl">
            We transition your goals into structured sprints, mapping your ideas
            ...
            {steps.map((step, idx) => {
              ...
              return (
                ...
                >
                  {/* Glowing Node Circle */}
                  <div
                    className={`w-16 h-16 rounded-full bg-white border-2 ${step.glow} flex items-center justify-center shrink-0 z-10 transition-all duration-300 group-hover:scale-115 group-hover:bg-slate-50 group-hover:border-slate-800 group-hover:shadow-md`}
                  >
  ...
  const approachData = [
    {
      ...
      description:
        "We believe that building a digital product isn’t just about code and design — it’s about creating lasting value for your business. Our approach is centered on direct developer integration and clear alignments.",
      bullets: [
    ...
    },
    {
      ...
      description:
        "We replace templated shortcuts with tailored, high-performance software systems. Every line of code is structured for fast rendering, security, and long-term expandability.",
      bullets: [
    ...
    },
    {
      ...
      description:
        "We are not the team that disappears after launch. Our products are architected to scale dynamically alongside your customer volume and enterprise operations.",
      bullets: [
          ...
          <div className="lg:col-span-8 relative">
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <div
                  className={`w-14 h-14 rounded-2xl ${approachData[activeTab].accentBg} flex items-center justify-center shrink-0`}
                >
                  <ActiveIcon
                    className={`w-7 h-7 ${approachData[activeTab].accentColor}`}
                  />
                </div>
                ...
                <div className="flex flex-col text-left gap-4">
                  ...
                  <ul className="flex flex-col gap-3 mt-2">
                    {approachData[activeTab].bullets.map(
                      (bullet, bulletIdx) => (
                        <li
                          key={bulletIdx}
                        ...
                        >
                          <CheckCircle
                            className={`w-4 h-4 ${approachData[activeTab].accentColor} shrink-0 mt-0.5`}
                          />
                          <span>{bullet}</span>
                        </li>
                      ),
...
export default function About() {
  useEffect(() => {
    fetch(`${API_BASE}/api/settings/seo_about`)
      .then((r) => r.json())
      .then((data) => {
        if (data) applyPageSEO(data);
      })
      .catch(() => {});
  }, []);
